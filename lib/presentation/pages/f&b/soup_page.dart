...
import 'package:main_food_order/presentation/widgets/menu_page/soup/cream_soup.dart';
import 'package:main_food_order/presentation/widgets/menu_page/soup/mushroom_soup.dart';
          ...
          child: ListView(
            children: [
              GestureDetector(
                ...
                child:
                    const CustomMenu(index: 11, gambar: "lib/asset/creamsoup.png"),
              ),
              GestureDetector(
                onTap: () {
                  Navigator.push(
                ...
                child:
                    const CustomMenu(index: 12, gambar: "lib/asset/mushroomsoup.png"),
              ),
            ],
          ),
        ),
