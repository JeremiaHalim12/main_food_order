...
import 'package:main_food_order/presentation/widgets/menu_page/noodle/yamien_asin.dart';
import 'package:main_food_order/presentation/widgets/menu_page/noodle/yamien_manis.dart';
          ...
          child: ListView(
            children: [
              GestureDetector(
                ...
                child:
                    const CustomMenu(index: 9, gambar: "lib/asset/friednoodle.png"),
              ),
              GestureDetector(
                onTap: () {
                  Navigator.push(
                ...
                child:
                    const CustomMenu(index: 16, gambar: "lib/asset/yamienasin.png"),
              ),
            ],
          ),
        ),
